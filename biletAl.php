...
<?php
    ...
    $sql="SELECT DISTINCT(sefer_from) FROM sefer ";
...
<html lang="en">
    ...
    <body>
        <div id="page">
            ...
            padding:0px; ">
                <div style="width:100%; background-color:#162541; height:50px; color:white;"><h4 align="center" style="padding:10px;">Bilet Al</h4></div>
                    <br />
                    <br />
                    <br />
                    <div class="container">
                    <form action="biletalodeme.php" method="get">
                        <label for="fname" style="margin-left:15px;">Nerden?</label>
                        <label for="fname" style="margin-left:120px;">Nereye?</label>
                        <br />
                        <div style="display:inline;">
                        <select   name="from" onchange="getTo(this.value)">
                        <option> Nerden</option>
                        <?php while($records =  mysqli_fetch_array($result)) {?>
                        <option value="<?php echo"{$records['sefer_from']}"?>"><?php echo"{$records['sefer_from']}"?></option>
                        <?php
                        } 
                            mysqli_close($con);
                        ?>
                        ...
                        <div style="display:inline;" id="to">                
                        <select  name="to" style="margin-left:15px;">
                        ...
                        <label for="Tarih" style="margin-left:15px;">Tarih</label>
                        <label for="Saat" style="margin-left:120px;">Saat</label>
                        <br />
                        ...
                        <select  name="time" style="margin-left:15px;">
                        <option>Saat</option>
                        ...
                        <br />
                        <br />
                        <label for="koltuk" style="margin-left:120px;">koltuk</label>
                        <br />
                        <div id="seat" style="display:inline;">
                        ...
                        <br />                    
                        <input name="satin" style="margin-left:70px;" type="submit" value="İLERİ">
                    </form>
                </div>
            </div>
           <!--footer-->
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 width-50 width-set-50">
                            <div class="footer-details">
                                ...
                                <ul class="list-unstyled footer-links">
                                    ...
                                    <li href="about.php"><a>Hakkımızda</a></li>
        ...
        <script>
                    ...
                    xmlhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                            document.getElementById("to").innerHTML = this.responseText;
                             document.getElementById('date').innerHTML='<select name="date">'+ 
                             '<option>Tarih</option>'                           
                            +'</select>';                                 
                        }
                    };
                    xmlhttp.open("GET","to.php?q="+str,true);
                    xmlhttp.send();
              }               
            }
            ...
            function getdate(from,to) {                    
                    if (to == "") {
                        ...
                        xmlhttp.open("GET","date.php?from="+from+"&to="+to,true);
                        xmlhttp.send();
                ...
                function gettime(from,to,date) {                    
                    if (date == "") {
                        ...
                        xmlhttp.open("GET","time.php?from="+from+"&to="+to+"&date="+date,true);
                        xmlhttp.send();
                 ...
                 function getseat(from,to,date,time) {                    
                    if (time == "") {
                        ...
                        xmlhttp.open("GET","seat.php?from="+from+"&to="+to+"&date="+date+"&time="+time,true);
                        xmlhttp.send();
