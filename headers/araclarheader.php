                    ...
                    <div class="top-row">
                        <div class="row">
                            ...
                            <div class="col-sm-6 visible-sm">
                                <div class="text-right"><button type="button" class="book-now-btn">giriş yap</button></div>
                            </div>
                                    ...
                                    <div class="collapse navigation navbar-collapse navbar-ex1-collapse remove-space">
                                        <ul class="list-unstyled nav1 cl-effect-10">
                                           ...
                                           <li><a data-hover="Anasayfa" href="index.php"><span>Anasayfa</span></a></li>
                                            ...
                                            <li><a data-hover="Araçlar"  href="araclar.php"  class="active"><span>Araçlar</span></a></li>
